...
namespace GroupFlightPlanner.Controllers
{
    public class OrganizationController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            // curl https://localhost:44380/api/Organizationdata/listOrganizations
        ...
        {
            //connects with OrganizationData to fetch list of Organizations from Db.
            // curl https://localhost:44380/api/Organizationdata/findOrganization
        ...
        public ActionResult Create(Organization Organization)
        {
            ...
            //curl -H "Content-type:application/json -d @Organization.json https://localhost:44380/api/Organizationdata/addOrganization
        ...
        public ActionResult Edit(int id)
        {
            ...
            //curl https://localhost:44380/api/Organizationdata/findOrganization/{id}
        ...
        public ActionResult Update(int id, Organization Organization)
        {
            ...
            //objective: add the new Organization data received into our db using our API.
            //curl -H "Content-type:application/json -d @Organization.json https://localhost:44380/api/Organizationdata/updateOrganization
            try
            {
        ...
        public ActionResult Delete(int id, Organization Organization)
        {
            ...
            //objective: add the new Organization data received into our db using our API.
            //curl -H "Content-type:application/json -d @Organization.json https://localhost:44380/api/Organizationdata/deleteOrganization
            try
            {
