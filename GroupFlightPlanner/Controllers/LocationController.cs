...
namespace GroupFlightPlanner.Controllers
{
    public class LocationController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            // curl https://localhost:44380/api/locationdata/listlocations
        ...
        {
            //connects with locationdata to fetch list of locations from Db.
            // curl https://localhost:44380/api/locationdata/findlocation
        ...
        public ActionResult Create(Location location)
        {
            ...
            //curl -H "Content-type:application/json -d @location.json https://localhost:44380/api/locationdata/addlocation
        ...
        public ActionResult Edit(int id)
        {
            ...
            //curl https://localhost:44380/api/locationdata/findlocation/{id}
        ...
        public ActionResult Update(int id, Location location)
        {
            ...
            //objective: add the new location data received into our db using our API.
            //curl -H "Content-type:application/json -d @location.json https://localhost:44380/api/locationdata/updatelocation
            try
            {
        ...
        public ActionResult Delete(int id, Location location)
        {
            ...
            //objective: add the new location data received into our db using our API.
            //curl -H "Content-type:application/json -d @location.json https://localhost:44380/api/locationdata/deletelocation
            try
            {
