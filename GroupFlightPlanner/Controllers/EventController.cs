...
namespace GroupFlightPlanner.Controllers
{
    public class EventController : Controller
    {
        ...
        public ActionResult List()
        {
            ...
            // curl https://localhost:44380/api/eventdata/listevents
        ...
        public ActionResult Create(Event Event)
        {
            ...
            //curl -H "Content-type:application/json -d @Event.json https://localhost:44380/api/eventdata/addevent
        ...
        public ActionResult Edit(int id)
        {
            ...
            //curl https://localhost:44380/api/eventdata/findevent/{id}
        ...
        public ActionResult Update(int id, Event Event)
        {
            ...
            //objective: add the new event data received into our db using our API.
            //curl -H "Content-type:application/json -d @Event.json https://localhost:44380/api/eventdata/updateevent
            try
            {
        ...
        public ActionResult Delete(int id, Event Event)
        {
            ...
            //objective: add the new event data received into our db using our API.
            //curl -H "Content-type:application/json -d @Event.json https://localhost:44380/api/eventdata/deleteevent
            try
            {
